...
{
$sql=mysql_query("SELECT password FROM  enrollteacher where Password='".$_POST['password']."' && username='".$_SESSION['login']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update enrollteacher set Password='".$_POST['newpassword']."' where username='".$_SESSION['login']."'");
...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal| Teacher Change Password</title>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Teacher Change Password</h4>
