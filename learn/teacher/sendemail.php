...
<html lang="en">
  <head>
    ...
    <title>Safe Exam portal | Send E-Mail</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Send E-mail to Parents</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
...
<?php } ?>
            <td align="center">
           <a href="email.php?id=<?php echo  $row[0];?>">
            <button type="button" class="btn btn-primary">Send</button></a>
             </td>
                                </tr>
                              <?php } ?>
