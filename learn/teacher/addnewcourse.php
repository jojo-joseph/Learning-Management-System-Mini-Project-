...
$query=mysql_query("insert into addnewcourse(programname,subjectname,teachername,cname) values('$programname','$subjectname','$teachername','$coursename ')") or die(err());
...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Add New Course</title>
