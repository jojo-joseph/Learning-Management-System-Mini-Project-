...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Manage Courses </title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Manage Courses</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
...
?>
  ...
  $query=mysql_query("select * from addnewcourse where teachername='$tname'");
while($row=mysql_fetch_array($query))
{
  ?>
                              <tr>
                                 ...
                                 <td align="center"><?php echo  htmlentities($row[4]);?>
                                   <td align="center">
                                   <a href="deletecourse.php?id=<?php echo  $row[0];?>">
