...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Enroll Student List </title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Enroll Student List</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
...
while($row=mysql_fetch_array($query))
{
  ?>
                              <tr>
                                 ...
                                 <td align="center"><?php echo  htmlentities($row[8]);?>
                                   <td align="center">
                                   <a href="deletestudent.php?id=<?php echo  $row[0];?>">
