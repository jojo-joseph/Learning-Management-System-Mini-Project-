...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Upload Materials List </title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Uploaded Study Materials List</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
...
?>
  ...
  $query=mysql_query("select * from uploadstudymeterial where teachername='$tname'");
  ...
  ?>
                              <tr>
                                  ...
                                  <td align="center"><?php echo htmlentities($row[3]);?></td>                
                                   <td align="center">
                                   <a href="/learn/teacher/file/<?php echo $row[3] ?>" target="_blank">view file</a>                                 
                                   </td>
                        
 <td align="center">
                                   <a href="deletedoccu.php?id=<?php echo  $row[0];?>">
