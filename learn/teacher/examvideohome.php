...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Video Exam Home </title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Video Exam Details</b></span><br /><br />

 <div class="col-md-3"></div><div class="col-md-6">   
 <form class="form-horizontal style-form" method="post" name="exam" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="4" name="desc" class="form-control" placeholder="Write description here..."></textarea>  
  </div>
</div>
