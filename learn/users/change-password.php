...
{
$sql=mysql_query("SELECT password FROM  enrollstudent where password='".$_POST['password']."' && username='".$_SESSION['login']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update enrollstudent set password='".$_POST['newpassword']."' where username='".$_SESSION['login']."'");
...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal| Student Change Password</title>
