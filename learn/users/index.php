...
{
$ret=mysql_query("SELECT * FROM enrollstudent WHERE username='".$_POST['username']."' and password='".$_POST['password']."'");
...
$query=mysql_query("SELECT * FROM enrollstudent WHERE username='$uname' and password='$opassword'");
$num=mysql_fetch_array($query);
if($num>0)
{
mysql_query("update enrollstudent set password='$password' WHERE username='$uname' and password='$opassword' ");
$msg="Password Changed Successfully";

}
else
{
$errormsg="Invalid User Name or Old Password";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>Safe Exam Portal | Student Login</title>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username" placeholder="Student Name"  required autofocus>
		            <br>
...
<input type="text" name="uname" placeholder="User Name" autocomplete="off" class="form-control" required><br >
<input type="password" name="opassword" placeholder="Old Password" autocomplete="off" class="form-control" required><br>
