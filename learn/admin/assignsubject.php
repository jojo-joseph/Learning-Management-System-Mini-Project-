...
<?php include('include/sidebar.php');?>		
	...
	<div>
	<label class="control-label" for="basicinput">Select Teacher</label>
...
<td>
	...
	<a style="color: white;padding-left: 18px; padding-top: 20px" href="./selectsub.php?id=<?php $cookie_Value='curntTeacher'; echo $_COOKIE[$cookie_Value].':+'.$row['sid'] ?>">Select</a></div>
</td>
